...
// ***********************************************
// Program Abstract
// it makes fish in a grid in a spiral square patern counting from 1 to 100
// and changing color. It erases them AFter
// ***********************************************
...
public class Lab14 extends java.applet.Applet
{
	public void paint(Graphics g)
    {
          ...
          while (count <=400)
          {
	          for (int row = ar, col = ac; col < grow; col++) 
	          {
	          ...
	          if (clr==9)
	          	...
	          	clr++;
	          for (int row = ar+1, col = dc; row < grow; row++)
	          {
	          		fish.drawFish(g,row,col,clr,count);
	          		count++;
	          }
	          if (clr==9)
	          	...
	          	clr++;
	          for (int row = dr, col = dc-1; col >= shrink; col--)
	          {
	          		fish.drawFish(g,row,col,clr,count);
	          		count++;	
	          }
	          if (clr==9)
	          	...
	          	clr++;
	          for (int row = dr-1, col = ac; row >= shrink + 1; row--) 
	          {
	          		fish.drawFish(g,row,col,clr,count);
	          		count++;	
	          }
